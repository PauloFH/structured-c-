...
int main() {
    ...
    cout << "Gostaria de pedir alguma coisa?(S para sim e N para N�o)";
    cin >> Continuar;
    while (Continuar == 'S') {
       cout << "Fa�a seu pedido usando as letras (a, b, c):";
        cin >> escolha;
        switch (escolha)
        {
        case 'a':;
        ...
        cout << total << endl;
        cout << "Gostaria de pedir  mais alguma coisa?(S para sim e N para N�o)";
        cin >> Continuar;
    }

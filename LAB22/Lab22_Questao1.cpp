...
int main() {
    ...
    while (continuar == true) {
        cout << "Fa�a seu pedido usando as letras (a, b, c) e (s) para encerrar:";
        cin >> escolha;
        switch (escolha)
        {
        case 'a':  cout << "Quantos quilos de alface voc� gostaria?";
            cin >> qalface;
            break;
        case 'b':  cout << "Quantos quilos de beterraba voc� gostaria?";
            cin >> qbeter;
            break;
        case 'c':  cout << "Quantos quilos de cebola voc� gostaria?";
            cin >> qcebola;
            break;
        case 's':
            continuar = false;
    ...
    talf = pqalf * qalface;
    tbet = pqbet * qbeter;
    cout << "Produto\t\tPre�o/Kg\tPedido(Kg)\tTotal Parcial" << endl
        << "---------- -------- - ---------- - -------------- -" << endl
